...
releases: "0.23.0": {
	...
	description: """
		...
		Be sure to check out the [upgrade guide](/highlights/2022-05-23-0-23-0-upgrade-guide) for breaking changes in
		this release.

		In addition to the new features, enhancements, and fixes listed below, this release adds:

		- Support for loading secrets from an external process. See the [release highlight](TODO) for more.
		- Support for new encoding options to all sinks that support codecs, that mirror the decoding options available
		  ...
		  octet-framing) to be used on more sinks. See the [release highlight](TODO) for more.
		"""
	...
	changelog: [
		{
			...
			description: """
				...
				newline-delimited and octet-framing) to be used on more sinks. See the [release highlight](TODO) for
				more. on sources, allowing more codecs (like `json` and `logfmt`) to be used on more sinks. See the
				[release highlight](TODO) for more.
				"""
			pr_numbers: []
		},
		{
